...
urlpatterns = [
    ...
    path("cashbooks/export/summary/pdf/", views.cashbook_export_summary_pdf, name="cashbook_export_summary_pdf"),
    ...
    path("cashbooks/<int:pk>/export/receipts-print/", views.cashbook_print_receipts, name="cashbook_print_receipts"),
